...
console.log(data.replace("Nihar", "Guru"));  //  Nihar Guru
...
console.log(data.slice(1));  // ihar = start from 2 index to end of string
...
console.log(data.charCodeAt(122));  // z

console.log(data.split(""));  //  [ 'N', 'i', 'h', 'a', 'r' ]

console.log(data.repeat(3));  // NiharNiharNihar

console.log(data.substring(1, 4));  // iha  => same as slice
